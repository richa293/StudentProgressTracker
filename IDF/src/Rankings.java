...
public void Update_Table(int x,String y,String z)
{
 ...
 try
 {
     String sql="Select * from Student where Session='"+x+"' order by "+y+"";
     if(z.equals("Ascending"))
     sql="Select * from Student where Session='"+x+"' order by "+y+"";
     else if(z.equals("Descending"))
     sql="Select * from Student where Session='"+x+"' order by "+y+" desc";
